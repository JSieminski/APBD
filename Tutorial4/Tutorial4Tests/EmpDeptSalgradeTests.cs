...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(grades, e => true, s => true, (e, s) => new { e.EName, e.Sal, s.Grade, s.Losal, s.Hisal }).Where(joined => joined.Sal >= joined.Losal && joined.Sal <= joined.Hisal).Select(joined => new { joined.EName, joined.Grade }).ToList();
